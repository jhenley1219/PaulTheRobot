...
class SurveyApp(tk.Tk):
    def __init__(self):
        ...
        # Load prompts
        with open("study_materials/CONSENT.txt", "r", encoding="utf-8") as f: self.consent = f.read()
        with open("study_materials/INSTRUCTIONS.txt") as f: self.instructions = f.read()
        with open("study_materials/STORY.txt", "r", encoding="utf-8") as f: self.story = f.read()
        if self.framing == "Anthro":
            with open("study_materials/FRAMING_anthro.txt", "r", encoding="utf-8") as f: self.framing_text = f.read()
        else: # debug defaults to technical
            with open("study_materials/FRAMING_tech.txt", "r", encoding="utf-8") as f: self.framing_text = f.read()
